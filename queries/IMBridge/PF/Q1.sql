-- Select Expedia Holistic Prediction
SELECT Expedia_S_listings_1G.srch_id, Expedia_S_listings_1G.prop_id, PREDICT expedia_sklearn_dt_holistic(prop_location_score1, prop_location_score2, 
