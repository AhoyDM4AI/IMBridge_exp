...
class pf3(AbstractFunction):
    ...
    def setup(self):
        ...
        scaler_path = '"../../../raven_datasets/Flights/flights_standard_scale_model.pkl'
        enc_path = '"../../../raven_datasets/Flights/flights_one_hot_encoder.pkl'
        model_path = '"../../../raven_datasets/Flights/flights_rf_model.pkl'
