...
scaler_path = './test_raven/Expedia/expedia_standard_scale_model.pkl'
enc_path = './test_raven/Expedia/expedia_one_hot_encoder.pkl'
model_path = './test_raven/Expedia/expedia_dt_model.pkl'
