...
class pf5(AbstractFunction):
    ...
    def setup(self):
        ...
        scaler_path = '"../../../raven_datasets/Hospital/hospital_standard_scale_model.pkl'
        enc_path = '"../../../raven_datasets/Hospital/hospital_one_hot_encoder.pkl'
        model_path = '"../../../raven_datasets/Hospital/hospital_lr_model.pkl'
