...
class pf1(AbstractFunction):
    ...
    def setup(self):
        ...
        scaler_path = "../../../raven_datasets/Expedia/expedia_standard_scale_model.pkl"
        enc_path = ""../../../raven_datasets/Expedia/expedia_one_hot_encoder.pkl"
        model_path = ""../../../raven_datasets/Expedia/expedia_dt_model.pkl"
