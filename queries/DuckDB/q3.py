...
scaler_path = './test_raven/Flights/flights_standard_scale_model.pkl'
enc_path = './test_raven/Flights/flights_one_hot_encoder.pkl'
model_path = './test_raven/Flights/flights_rf_model.pkl'
